...
const DBStart = async () => {
	...
	// const client = await MongoClient.connect("mongodb+srv://ty12:ty12@cluster0.4qwao.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", {
	...
	//quiz = client.db('myFirstDatabase')
	//quiz = client.collection('myFirstDatabase');
	MongoClient.connect('mongodb+srv://ty12:ty12@cluster0.4qwao.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', (err, client) => {
		// Client returned
  		quiz = client.db('mytestingdb');
	});
}
DBStart()
const withDB = async (operations, res) => {
	try {
		await operations(quiz)
		// client.close()
	} catch (error) {
